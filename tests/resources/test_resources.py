...
banners = {
    "banner0": {
        ...
        "end_datetime": (datetime.now(timezone.utc) - timedelta(days=20)).strftime(
            "%Y-%m-%d %H:%M:%S"
        ),
    },
    "banner1": {
    ...
    "banner2": {
        ...
        "end_datetime": (datetime.now(timezone.utc) + timedelta(days=10)).strftime(
            "%Y-%m-%d %H:%M:%S"
        ),
    },
    "banner3": {
        ...
        "end_datetime": (datetime.now(timezone.utc) + timedelta(days=30)).strftime(
            "%Y-%m-%d %H:%M:%S"
        ),
    },
    "html_banner": {
